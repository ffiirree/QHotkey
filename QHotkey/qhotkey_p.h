...
private:
    ...
    Q_INVOKABLE void addMappingInvoked(Qt::Key keycode, Qt::KeyboardModifiers modifiers,
    ...
    Q_INVOKABLE QHotkey::NativeShortcut nativeShortcutInvoked(Qt::Key               keycode,
